...
#define ESCAPE_Pin GPIO_PIN_6
#define ESCAPE_GPIO_Port GPIOF
#define ENTER_Pin GPIO_PIN_7
#define ENTER_GPIO_Port GPIOF
#define LCD_LIGHT_Pin GPIO_PIN_15
#define LCD_LIGHT_GPIO_Port GPIOA

#define RTC_STATUS_Pin GPIO_PIN_0
#define RTC_STATUS_GPIO_Port GPIOB
#define RTC_DATA_Pin GPIO_PIN_1
